    ...
    const HomepageApp = {
        ...
        theme_marketwidget: function() {
            new MarketWidget({
                ...
                data: '/api/market-data?type=ticker-tape',      // url data source
                logo: true                         // set false if want hide symbol logo
            }).init()
            ...
            new MarketWidget({
                ...
                data: '/api/market-data?type=mini-chart'        // url data source
            }).init()
            
            new MarketWidget({
                variants: 'market-list',            // market widget variant (market-list, jumbo-chart, mini-chart, ticker-tape, ticker)
                theme: 'light',                     // widget theme (dark, light)
                data: '/api/market-data?type=market-list'       // url data source
            }).init()
        },
        theme_init: function() {
