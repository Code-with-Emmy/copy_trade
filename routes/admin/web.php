...
Route::prefix('adminlogin')->group(function () {
    Route::controller(ForgotPasswordController::class)->middleware('adminguest')->group(function () {
        Route::get('forgot-password', 'forgotPassword')->name('adminforgotpassword');
        Route::post('forgot-password', 'sendPasswordRequest')->name('sendpasswordrequest');
        Route::get('reset/{email}', 'resetPassword')->name('resetview');
        Route::post('reset-password', 'validateResetPasswordToken')->name('restpass');
    });

    Route::controller(LoginController::class)->group(function () {
        Route::get('secure', 'showLoginForm')->name('adminloginform')->middleware('adminguest');
...
Route::middleware(['isadmin', '2fa'])->prefix('admin')->group(function () {
    ...
    Route::get('users', fn () => redirect()->route('manageusers'))->name('admin.users.index');
    Route::get('deposits', fn () => redirect()->route('mdeposits'))->name('admin.deposits.index');
    Route::get('withdrawals', fn () => redirect()->route('mwithdrawals'))->name('admin.withdrawals.index');
    Route::get('kyc', fn () => redirect()->route('kyc'))->name('admin.kyc.index');
    Route::get('profile', fn () => redirect()->route('adminprofile'))->name('admin.profile');
    Route::get('security', fn () => redirect()->route('admin.password'))->name('admin.security');
    Route::get('settings/platform', fn () => redirect()->route('appsettingshow'))->name('admin.settings.platform');
    Route::get('settings/payments', fn () => redirect()->route('paymentview'))->name('admin.settings.payments');
    Route::get('content', fn () => redirect()->route('frontpage'))->name('admin.content.index');
    Route::get('team', fn () => redirect()->route('madmin'))->name('admin.team.index');
    ...
    Route::controller(KycController::class)->group(function () {
        Route::get('dashboard/processkyc', 'processKycPage')->name('processkyc.page');
    ...
    Route::controller(ManageUsersController::class)->group(function () {
        ...
        Route::get('dashboard/users/{id}', 'viewuser')->name('admin.users.show');
    ...
    Route::controller(ManageAdminController::class)->group(function () {
        ...
        Route::get('dashboard/adminchangepassword', 'adminchangepassword')->name('admin.password');
        ...
        Route::match(['get', 'post'], 'dashboard/changestyle', 'changestyle')->name('changestyle');
    ...
    */
    ...
    Route::prefix('dashboard/bots')->name('admin.bots.')->controller(BotController::class)->group(function () {
        Route::get('/', 'index')->name('index');
        Route::get('/dashboard', 'dashboard')->name('dashboard');
        Route::get('/create', 'create')->name('create');
        Route::post('/', 'store')->name('store');
        Route::get('/{bot}', 'show')->name('show');
        Route::get('/{bot}/edit', 'edit')->name('edit');
        Route::put('/{bot}', 'update')->name('update');
        Route::delete('/{bot}', 'destroy')->name('destroy');
        Route::post('/{bot}/toggle-status', 'toggleStatus')->name('toggle-status');
        Route::get('/{bot}/analytics', 'analytics')->name('analytics');
    });
