                            ...
                            <tbody>
                                @foreach ($signals as $signal)
                                    <tr>
                                        ...
                                        <td>{{ $signal->suser->name ?? 'User deleted' }}</td>
                                        <td>{{ $signal->asset }}</td>
                                        ...
                                        @if ($signal->order_type == 'Buy')
                                            <td><strong><span class="text-success"><i
                                                            class="fas fa-arrow-up mr-1"></i>{{ $signal->order_type }}</span></strong></i>
                                            </td>
                                        @else
                                            <td><strong><span class="text-danger"><i
                                                            class="fas fa-arrow-down mr-1"></i>{{ $signal->order_type }}</span></strong></i>
                                            </td>
                                        @endif
                                        <td>{{ $signal->dsignal->name ?? 'Signal Deleted' }}</td>
                                        <td>
