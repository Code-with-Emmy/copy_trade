...
@section('content')
    <div class="page-content-stack animate-in fade-in slide-in-from-bottom-6 duration-1000">
        <div>
            ...
            <h1 class="text-3xl font-black tracking-tight text-white">Frontpage <span class="gold-text">Editor</span></h1>
            <p class="mt-1 max-w-3xl text-sm font-medium text-slate-400">
                Curate FAQs, testimonials, website content blocks, and media assets from a unified dashboard-style content studio.
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-4">
            <div class="dashboard-glass p-6 sm:p-7">
                <p class="text-[10px] font-black uppercase tracking-widest text-slate-500">FAQ Items</p>
                <h2 class="mt-4 text-2xl font-black tracking-tight text-white">{{ number_format($faqs->count()) }}</h2>
                <p class="mt-2 text-[10px] font-black uppercase tracking-widest text-slate-400">Questions shown on the public site</p>
            </div>
            <div class="dashboard-glass p-6 sm:p-7">
                <p class="text-[10px] font-black uppercase tracking-widest text-slate-500">Testimonials</p>
                <h2 class="mt-4 text-2xl font-black tracking-tight gold-text">{{ number_format($testimonies->count()) }}</h2>
                <p class="mt-2 text-[10px] font-black uppercase tracking-widest text-slate-400">Social proof blocks on the homepage</p>
            </div>
            <div class="dashboard-glass p-6 sm:p-7">
                <p class="text-[10px] font-black uppercase tracking-widest text-slate-500">Content Blocks</p>
                <h2 class="mt-4 text-2xl font-black tracking-tight text-white">{{ number_format($contents->count()) }}</h2>
                <p class="mt-2 text-[10px] font-black uppercase tracking-widest text-slate-400">Editable marketing copy sections</p>
            </div>
            <div class="dashboard-glass p-6 sm:p-7">
                <p class="text-[10px] font-black uppercase tracking-widest text-slate-500">Images</p>
                <h2 class="mt-4 text-2xl font-black tracking-tight text-white">{{ number_format($images->count()) }}</h2>
                <p class="mt-2 text-[10px] font-black uppercase tracking-widest text-slate-400">Managed media assets for the front page</p>
            </div>
        </div>
                ...
                <div class="dashboard-glass p-4 sm:p-6">
                    ...
                    <div class="col-12 mt-2">
                        ...
                        <div class="px-0 py-3 tab-content" id="nav-tabContent">
