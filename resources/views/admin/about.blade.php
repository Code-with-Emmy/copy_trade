...
@section('content')
    <div class="page-content-stack animate-in fade-in slide-in-from-bottom-6 duration-1000">
        <section class="admin-page-header">
            <div>
                <span class="admin-page-kicker">About Section</span>
                <h1 class="title1 mb-0">Developer support and services</h1>
                <p class="admin-page-subtitle">Reference the product author, support channels, service coverage, and customization capabilities from a cleaner admin information page.</p>
            </div>
            <div class="admin-page-actions">
                <a href="https://developerplug.com" target="_blank" class="btn btn-primary btn-sm">Visit Website</a>
                <a href="https://developerplug.com" target="_blank" class="btn btn-outline-light btn-sm">Get Support</a>
            </div>
        </section>
                ...
                <div class="row mb-4">
                    <div class="col-12">
                        <div class="card shadow-lg border-0" style="background: radial-gradient(circle at top right, rgba(240, 185, 10, 0.16), transparent 30%), linear-gradient(135deg, rgba(10,17,28,0.98), rgba(15,23,42,0.96));">
                            <div class="card-body text-center text-white py-5">
                                <div class="mb-4">
                                    <i class="fas fa-code fa-4x mb-3 opacity-75 gold-text"></i>
                                </div>
                                <h1 class="display-4 fw-bold mb-3">Ofofonobs Developer</h1>
                                ...
                                <div class="d-flex justify-content-center gap-3 flex-wrap">
                                    <a href="https://developerplug.com" target="_blank" class="btn btn-light btn-lg px-4">
                                        <i class="fab fa-telegram me-2"></i>Get Support
                                    </a>
                                    <a href="https://developerplug.com" target="_blank" class="btn btn-outline-light btn-lg px-4">
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-4">
                                                <div class="p-3 bg-white rounded">
                                                    ...
                                                    <a href="https://developerplug.com" target="_blank" class="btn btn-primary btn-sm">Join Channel</a>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="p-3 bg-white rounded">
                                                    ...
                                                    <a href="https://developerplug.com" target="_blank" class="btn btn-primary btn-sm">developerplug.com</a>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="p-3 bg-white rounded">
                                                    ...
                                                    <a href="https://developerplug.com" class="btn btn-primary btn-sm"></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
