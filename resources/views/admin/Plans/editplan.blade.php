                        ...
                        <div class="p-3 card ">
                            <form role="form" method="post" action="{{ route('updateplan') }}">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <h5 class="">Expected Return (ROI)</h5>
                                        <input class="form-control" placeholder="Enter Expected Return" type="text"
                                            name="return" value='{{ $plan->expected_return ?? '' }}'>
                                        <small class="">Optional expected return for this plan.
                                        </small>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <h5 class="">Plan Tag</h5>
                                        <input class="form-control" placeholder="Enter Plan Tag" type="text" step="any"
                                            name="tag" value='{{ $plan->tag ?? '' }}'>
                                        <small class="">Optional Plan tag. This is tags for each plan eg 'Popular' , 'VIP'
                                            etc
                                        </small>
                                    </div>
                                    <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        <h5 class="">Top up Amount (in % or
                                            {{ $settings->currency }} as specified above)
                                        </h5>
