...
<head>
    ...
    <style>
        ...
        .btn-primary {
            @apply bg-primary hover:bg-primary-700 text-white font-bold py-3 px-6 rounded-lg transition-all duration-200;
        }
    ...
    <meta property="og:description"
        content="CFD Trading with {{ $settings->site_name }}. Trading on Stocks, Gold, Oil, Indices with ultra-fast execution &amp; spreads from 0.0 pips. News, articles and training materials for experienced and novice traders.">
    ...
    <meta property="og:title"
        content="CFD Trading — Trading on Stocks, Gold, Oil, Indices | {{ $settings->site_name }}">
...
<body class="antialiased text-gray-200 bg-gray-900 font-sans min-h-screen flex flex-col">
    ...
    <a href="#main-content"
        class="sr-only focus:not-sr-only focus:bg-primary-700 focus:text-white focus:fixed focus:px-4 focus:py-2 focus:top-2 focus:left-2 focus:z-50">
                ...
                <div class="flex items-center justify-between h-16">
                    ...
                    <div class="flex-shrink-0">
                        <a href="{{ route('home') }}" class="flex items-center">
                            <img class="h-8 w-auto" src="{{ asset('storage/' . $settings->logo) }}"
                    ...
                    <nav class="hidden md:flex space-x-8">
                        <div class="relative" x-data="{ open: false }">
                            <button @click="open = !open" @click.away="open = false"
                                class="group inline-flex items-center px-1 pt-1 text-sm font-medium text-gray-200 hover:text-white focus:outline-none">
                                <span>Trading</span>
                                <svg class="ml-2 h-4 w-4 text-gray-400 group-hover:text-gray-300"
                            ...
                            <div x-show="open" x-transition:enter="transition ease-out duration-200"
                                ...
                                class="absolute left-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-dark-300 ring-1 ring-black ring-opacity-5 z-50"
                                style="display: none;">
                                <a href="{{ route('cryptocurrencies') }}"
                                    class="block px-4 py-2 text-sm text-gray-200 hover:bg-dark-200">Cryptocurrencies</a>
                                <a href="{{ route('forex') }}"
                                    class="block px-4 py-2 text-sm text-gray-200 hover:bg-dark-200">Forex</a>
                                <a href="{{ route('shares') }}"
                                    class="block px-4 py-2 text-sm text-gray-200 hover:bg-dark-200">Shares</a>
                                <a href="{{ route('indices') }}"
                                    class="block px-4 py-2 text-sm text-gray-200 hover:bg-dark-200">Indices</a>
                                <a href="{{ route('etfs') }}"
                                    class="block px-4 py-2 text-sm text-gray-200 hover:bg-dark-200">ETFs</a>
                            </div>
                        </div>
                        ...
                        <div class="relative" x-data="{ open: false }">
                            ...
                            <div x-show="open" x-transition:enter="transition ease-out duration-200"
                                ...
                                style="display: none;">
                                <a href="{{ route('trade') }}"
                                    class="block px-4 py-2 text-sm text-gray-200 hover:bg-dark-200">Trade</a>
                                <a href="{{ route('copy') }}"
                                    class="block px-4 py-2 text-sm text-gray-200 hover:bg-dark-200">Copy
                                    Trading</a>
                                <a href="{{ route('automate') }}"
                                    class="block px-4 py-2 text-sm text-gray-200 hover:bg-dark-200">Automated
                                    Trading</a>
                            </div>
                        </div>
                        ...
                        <div class="relative" x-data="{ open: false }">
                            ...
                            <div x-show="open" x-transition:enter="transition ease-out duration-200"
                                ...
                                style="display: none;">
                                <a href="{{ route('about') }}"
                                    class="block px-4 py-2 text-sm text-gray-200 hover:bg-dark-200">About
                                    Us</a>
                                <a href="{{ route('why-us') }}"
                                    class="block px-4 py-2 text-sm text-gray-200 hover:bg-dark-200">Why
                                    Us</a>
                                <a href="{{ route('faq') }}"
                                    class="block px-4 py-2 text-sm text-gray-200 hover:bg-dark-200">FAQ</a>
                                <a href="{{ route('regulation') }}"
                                    class="block px-4 py-2 text-sm text-gray-200 hover:bg-dark-200">Legal &
                                    Regulation</a>
                            </div>
                        </div>

                        <a href="{{ route('fortrader') }}"
                            class="inline-flex items-center px-1 pt-1 text-sm font-medium text-gray-200 hover:text-white">Education</a>
                        <a href="{{ route('contact') }}"
                            class="inline-flex items-center px-1 pt-1 text-sm font-medium text-gray-200 hover:text-white">Contact</a>
                    </nav>
                    ...
                    <div class="hidden md:flex items-center">
                        ...
                        <div class="flex items-center space-x-4">
                            <a href="{{ route('login') }}" class="text-gray-200 hover:text-white flex items-center">
                ...
                <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                    ...
                    <div x-data="{ open: false }" class="py-1">
                        ...
                        <div x-show="open" class="pl-4">
                            <a href="{{ route('cryptocurrencies') }}"
                                class="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-700">Cryptocurrencies</a>
                            <a href="{{ route('forex') }}" class="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-700">Forex</a>
                            <a href="{{ route('shares') }}" class="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-700">Shares</a>
                            <a href="{{ route('indices') }}"
                                class="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-700">Indices</a>
                            <a href="{{ route('etfs') }}" class="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-700">ETFs</a>
                        </div>
                    </div>
                    ...
                    <div x-data="{ open: false }" class="py-1">
                        ...
                        <div x-show="open" class="pl-4">
                            <a href="{{ route('trade') }}" class="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-700">Trade</a>
                            <a href="{{ route('copy') }}" class="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-700">Copy
                                Trading</a>
                            <a href="{{ route('automate') }}" class="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-700">Automated
                                Trading</a>
                        </div>
                    </div>
                    ...
                    <div x-data="{ open: false }" class="py-1">
                        ...
                        <div x-show="open" class="pl-4">
                            <a href="{{ route('about') }}" class="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-700">About
                                Us</a>
                            <a href="{{ route('why-us') }}" class="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-700">Why
                                Us</a>
                            <a href="{{ route('faq') }}" class="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-700">FAQ</a>
                            <a href="{{ route('regulation') }}" class="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-700">Legal
                                & Regulation</a>
                        </div>
                    </div>

                    <a href="{{ route('fortrader') }}" class="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-700">Education</a>
                    <a href="{{ route('contact') }}" class="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-700">Contact</a>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-400 mb-6">
                                {{ $settings->site_name }} offers CFD trading on stocks, forex, indices, commodities,
                                and cryptocurrencies with competitive spreads and advanced trading tools.
                            </p>
                        ...
                        <div>
                            ...
                            <ul class="space-y-3">
                                <li><a href="{{ route('about') }}"
                                        ...
                                        Us</a></li>
                                <li><a href="{{ route('why-us') }}"
                                        class="text-sm text-gray-400 hover:text-white transition">Why
                                        Choose Us</a></li>
                                <li><a href="{{ route('fortrader') }}"
                        ...
                        <div>
                            ...
                            <ul class="space-y-3">
                                <li><a href="{{ route('cryptocurrencies') }}"
                                        class="text-sm text-gray-400 hover:text-white transition">Cryptocurrencies</a>
                                </li>
                                <li><a href="{{ route('forex') }}" class="text-sm text-gray-400 hover:text-white transition">Forex</a>
                                </li>
                                <li><a href="{{ route('shares') }}"
                                        class="text-sm text-gray-400 hover:text-white transition">Shares</a></li>
                                <li><a href="{{ route('indices') }}"
                                        class="text-sm text-gray-400 hover:text-white transition">Indices</a></li>
                            </ul>
                        </div>

                        <!-- Account -->
                        <div>
                            <h3 class="text-sm font-semibold text-white uppercase tracking-wider mb-4">Your Account
                            </h3>
                            <ul class="space-y-3">
                                <li><a href="{{ route('login') }}"
                                        class="text-sm text-gray-400 hover:text-white transition">Log
                                        In</a></li>
                ...
                <div class="py-6">
                    <div class="text-xs text-gray-400">
                        ...
                        <div class="flex flex-wrap gap-4 mb-4">
                            <a href="{{ route('terms') }}" class="text-primary-400 hover:text-primary-300 transition">Terms &
                                Conditions</a>
                            <a href="{{ route('privacy') }}" class="text-primary-400 hover:text-primary-300 transition">Privacy
                                Policy</a>
                            <a href="{{ route('regulation') }}" class="text-primary-400 hover:text-primary-300 transition">Legal
                                Documents</a>
                        </div>
                        <p>©
                            <script>
                                document.write(new Date().getFullYear())
                            </script> {{ $settings->site_name }}. All Rights Reserved.
                        </p>
                    </div>
                </div>
            </div>
    ...
    {{-- <div class="fixed bottom-20 right-6 z-40">
        <button onclick="openLiveChat(event)"
            class="bg-primary-600 hover:bg-primary-700 text-white rounded-full p-4 shadow-lg flex items-center justify-center transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-primary-400 focus:ring-opacity-50">
