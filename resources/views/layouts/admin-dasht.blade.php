...
<body class="antialiased" x-data="{ sidebarOpen: false, fabOpen: false }">
    ...
    <div class="lg:ml-80 flex flex-col min-h-screen">
        ...
        <footer class="hidden lg:flex p-10 border-t border-white/5 text-slate-500 text-[11px] tracking-wide font-medium items-center justify-between">
            <p>&copy; {{ date('Y') }} {{ $settings->site_name }}. Admin operations console.</p>
            <div class="flex items-center space-x-8">
                <a href="{{ route('admin.profile') }}" class="hover:text-white transition-colors uppercase">Profile</a>
                <a href="{{ route('admin.settings.payments') }}" class="hover:text-white transition-colors uppercase">Payments</a>
