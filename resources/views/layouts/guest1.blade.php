...
<head>
    ...
    <!-- <link rel="stylesheet" href="{{ asset('temp/custom/assets/css/bootstrap.min.css') }}"> -->
    <!-- jQuery library -->
    <script src="{{ asset('temp/custom/assets/js/jquery.min.js') }}"></script>
    <!-- Popper JS -->
    <!-- <script src="{{ asset('temp/custom/assets/js/popper.min.js') }}"></script> -->
    ...
    <meta property="og:image" content="{{ asset('temp/custom/images/icon/icon-310x310.png') }}" />
