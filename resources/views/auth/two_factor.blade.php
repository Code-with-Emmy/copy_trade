            ...
            <div class="bg-gray-900 rounded-2xl p-8 shadow-2xl border border-gray-700">
                ...
                <div class="mb-6 p-4 rounded-xl border transition-all duration-300"
                    ...
                    <div class="flex items-start gap-3">
                        <i data-lucide="shield-alert" x-show="!recovery"
                            class="w-5 h-5 text-blue-400 mt-0.5 flex-shrink-0"></i>
                        <i data-lucide="alert-triangle" x-show="recovery"
                            class="w-5 h-5 text-amber-400 mt-0.5 flex-shrink-0"></i>
                        <div class="text-sm">
                ...
                <form method="POST" action="{{ route('two-factor.login') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="my-2 col-lg-12 text-center">
                            <button class="btn btn-link" type="button" x-show="! recovery" x-on:click="
                                        recovery = true;
                        ...
                        <div class="bg-white shadow card login-page roundedd border-1 ">
                            <div class="card-body">
                                <div class="mb-4 text-center">
                                    ...
                                    <div class="mb-4 text-sm text-center text-dark" x-show="recovery">
                                        {{ __('Please confirm access to your account by entering one of your emergency
                                        recovery codes.') }}
                                    </div>
                                </div>
