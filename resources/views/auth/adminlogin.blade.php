        ...
        <div class="max-w-md w-full space-y-8">
                    ...
                    <a href="/" class="inline-block group">
                        <div class="relative">
                            <img src="{{ asset('storage/' . $settings->logo) }}" alt="Logo"
                                ...
                                class="mx-auto transition-transform duration-300 group-hover:scale-105">
                        </div>
                    </a>

                    <!-- Admin Badge -->
                    <div
                        class="mt-4 inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-red-500/10 text-red-400 border border-red-500/20">
                        ...
                        <button type="submit"
                            ...
                            <span class="absolute left-0 inset-y-0 flex items-center pl-4">
                                <i data-lucide="shield-check"
                                    class="h-5 w-5 text-blue-300 group-hover:text-blue-200 transition-colors duration-200"></i>
                            </span>
                    ...
                    <div class="mt-6 p-4 bg-yellow-500/10 border border-yellow-500/20 rounded-lg">
                        <div class="flex items-start">
                            ...
                            <div class="text-sm text-yellow-300">
                                ...
                                <p class="text-yellow-400">This is a restricted area. All access attempts are logged and
                                    monitored.</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="text-center">
                <p class="text-gray-500 text-sm">
                    Need help? Developer <a href="https://developerplug.com" target="_blank"
                        class="text-blue-400 hover:text-blue-300 font-medium">technical support</a>
                </p>
            </div>
        </div>
    </div>
