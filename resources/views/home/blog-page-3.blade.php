...
<head>
	...
	<title>Blog - Theramanuel Brokerage</title>
				...
				<div class="row gy-3 gy-lg-0">
					<div class="col-md-12 col-lg-8">
						<article class="card mb-4">
							<img src="{{ asset('img/user/image-featured-cHWUtS.jpg') }}" class="card-img-top" alt="Here are 3 year-end strategies for high-net-worth families to consider">
							<div class="card-body blog-card p-3 p-md-4">
								<h3>
									<a href="blog/here-are-3-year-end-strategies-for-high-net-worth-families.html" class="link-dark text-decoration-none">Here are 3 year-end strategies for high-net-worth families to consider</a>
								</h3>
								...
								<div class="blog-author d-flex align-items-center">
									<img class="rounded-circle me-1" src="{{ asset('img/user/author-85z9UC.jpg') }}" alt="author" width="32" height="32">
									<small class="text-muted">
										Theramanuel<span class="mx-1">•</span>
									</small>
									<small class="text-muted">
										December 29, 2022
									</small>
							...
							<div class="card-footer blog-footer d-flex justify-content-between align-items-center px-3 px-md-4 py-2">
								...
								<a href="blog/here-are-3-year-end-strategies-for-high-net-worth-families.html" class="btn btn-link link-primary text-decoration-none p-0">Read more<i class="fas fa-arrow-right fa-sm ms-1"></i></a>
							</div>
						</article>
						<article class="card mb-4">
							<div class="card-body blog-card p-3 p-md-4">
								<h3>
									<a href="blog/the-lastpass-disclosure-of-leaked-password-vaults-is.html" class="link-dark text-decoration-none">The LastPass disclosure of leaked password vaults is being torn apart by security experts</a>
								</h3>
							...
							<div class="card-footer blog-footer d-flex justify-content-between align-items-center px-3 px-md-4 py-2">
								...
								<a href="blog/the-lastpass-disclosure-of-leaked-password-vaults-is.html" class="btn btn-link link-primary text-decoration-none p-0">Read more<i class="fas fa-arrow-right fa-sm ms-1"></i></a>
							</div>
						</article>
						<article class="card mb-4">
							<div class="card-body blog-card p-3 p-md-4">
								<h3>
									<a href="blog/turf-houses-icelands-original-green-buildings.html" class="link-dark text-decoration-none">Turf houses: Iceland&#x27;s original &#x27;green&#x27; buildings</a>
								</h3>
							...
							<div class="card-footer blog-footer d-flex justify-content-between align-items-center px-3 px-md-4 py-2">
								...
								<a href="blog/turf-houses-icelands-original-green-buildings.html" class="btn btn-link link-primary text-decoration-none p-0">Read more<i class="fas fa-arrow-right fa-sm ms-1"></i></a>
							</div>
						</article>
						<!-- pagination begin -->
