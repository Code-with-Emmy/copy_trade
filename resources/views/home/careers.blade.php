...
<head>
	...
	<title>Careers - Theramanuel Brokerage</title>
...
<body>
	...
	<main>
			...
			<div class="container">
				<div class="row justify-content-center">
					<div class="col-md-12 col-lg-9">
						<h1>Driven by <span class="text-highlight">experts and learners</span></h1>
						<p class="lead text-muted">Who are committed to making security a strength for every startup.</p>
						...
						<div class="row row-cols-1 row-cols-md-1 row-cols-lg-3 gx-0 gx-md-3 gx-lg-5 mt-4">
							<div class="col border-end-md-0 border-end-lg">
								...
								<a class="btn btn-link link-primary text-decoration-none p-0" href="#">Watch the video<i class="fas fa-arrow-right fa-sm ms-1"></i></a>
							...
							<div class="col border-end-md-0 border-end-lg">
								...
								<a class="btn btn-link link-primary text-decoration-none p-0" href="#">Meet the team<i class="fas fa-arrow-right fa-sm ms-1"></i></a>
								<hr class="d-lg-none my-3 my-md-3">
							</div>
							<div class="col">
								<h4 class="fw-bold">Our culture</h4>
								<p>Corporis suscipit laboriosa nisi ut aliquid ex ea commodi consequatur pariatur.</p>
								<a class="btn btn-link link-primary text-decoration-none p-0" href="#">See our values<i class="fas fa-arrow-right fa-sm ms-1"></i></a>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="border-bottom py-3">
							<div class="row align-content-center gy-1 gy-md-1 gy-lg-0">
								<div class="col-md-12 col-lg-5 d-flex align-items-center">
									<h5 class="fw-bold mb-0">Solutions engineer (entry level)</h5>
								</div>
								<div class="col-md-12 col-lg-4 d-flex align-items-center">
									<div class="d-flex align-items-center">
										<i class="fas fa-map-marker-alt fa-2x text-danger me-1"></i>
										<p class="mb-0">Stockholm, Sweden</p>
									</div>
								</div>
								<div class="col-md-12 col-lg-3 d-flex justify-content-lg-end">
									<a class="btn btn-primary rounded-pill" href="#">Apply for this job <i class="fas fa-file-alt fa-sm ms-1"></i></a>
								</div>
							</div>
						</div>
						<div class="border-bottom py-3">
							<div class="row align-content-center gy-1 gy-md-1 gy-lg-0">
								<div class="col-md-12 col-lg-5 d-flex align-items-center">
									<h5 class="fw-bold mb-0">Sales Development Representative</h5>
								</div>
								<div class="col-md-12 col-lg-4 d-flex align-items-center">
									<div class="d-flex align-items-center">
										<i class="fas fa-map-marker-alt fa-2x text-danger me-1"></i>
		...
		<section class="py-5 mt-n5 mb-3">
			<div class="container">
				<h2 class="d-none">Theramanuel gallery</h2>
					...
					<div class="col masonry-item">
						<div class="card border-0">
							<a href="img/blockit/in-gallery-image-1.jpg" data-img="img/blockit/in-gallery-image-1.jpg" data-thumb="img/blockit/in-gallery-image-1.jpg" data-alt="Gallery" data-width="600" data-height="522">
								<img src="{{ asset('img/blockit/in-gallery-image-1.jpg') }}" class="img-fluid rounded-1" alt="gallery-image">
					...
					<div class="col masonry-item">
						<div class="card border-0">
							<a href="img/blockit/in-gallery-image-2.jpg" data-img="img/blockit/in-gallery-image-2.jpg" data-thumb="img/blockit/in-gallery-image-2.jpg" data-alt="Gallery" data-width="600" data-height="378">
								<img src="{{ asset('img/blockit/in-gallery-image-2.jpg') }}" class="img-fluid rounded-1" alt="gallery-image">
								<div class="card-img-overlay d-flex justify-content-center align-items-end p-2">
					...
					<div class="col masonry-item">
						<div class="card border-0">
							<a href="img/blockit/in-gallery-image-3.jpg" data-img="img/blockit/in-gallery-image-3.jpg" data-thumb="img/blockit/in-gallery-image-3.jpg" data-alt="Gallery" data-width="600" data-height="236">
								<img src="{{ asset('img/blockit/in-gallery-image-3.jpg') }}" class="img-fluid rounded-1" alt="gallery-image">
								<div class="card-img-overlay d-flex justify-content-center align-items-end p-2">
					...
					<div class="col masonry-item">
						<div class="card border-0">
							<a href="img/blockit/in-gallery-image-6.jpg" data-img="img/blockit/in-gallery-image-6.jpg" data-thumb="img/blockit/in-gallery-image-6.jpg" data-alt="Gallery" data-width="600" data-height="522">
								<img src="{{ asset('img/blockit/in-gallery-image-6.jpg') }}" class="img-fluid rounded-1" alt="gallery-image">
								<div class="card-img-overlay d-flex justify-content-center align-items-end p-2">
					...
					<div class="col masonry-item">
						<div class="card border-0">
							<a href="img/blockit/in-gallery-image-5.jpg" data-img="img/blockit/in-gallery-image-5.jpg" data-thumb="img/blockit/in-gallery-image-5.jpg" data-alt="Gallery" data-width="600" data-height="378">
								<img src="{{ asset('img/blockit/in-gallery-image-5.jpg') }}" class="img-fluid rounded-1" alt="gallery-image">
								<div class="card-img-overlay d-flex justify-content-center align-items-end p-2">
					...
					<div class="col masonry-item d-md-none d-lg-block">
						<div class="card border-0">
							<a href="img/blockit/in-gallery-image-4.jpg" data-img="img/blockit/in-gallery-image-4.jpg" data-thumb="img/blockit/in-gallery-image-4.jpg" data-alt="Gallery" data-width="600" data-height="236">
								<img src="{{ asset('img/blockit/in-gallery-image-4.jpg') }}" class="img-fluid rounded-1" alt="gallery-image">
								<div class="card-img-overlay d-flex justify-content-center align-items-end p-2">
	...
	<script src="{{ asset('js/vendors/bigger-picture.min.js') }}"></script>
	<script src="{{ asset('js/vendors/shuffle.min.js') }}"></script>
