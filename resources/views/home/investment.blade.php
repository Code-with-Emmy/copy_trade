            ...
            <div class="relative bg-gray-800 bg-opacity-80 backdrop-filter backdrop-blur-sm rounded-xl p-8 border border-gray-700">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8" x-data="{ showCalculator: true }">
                    <div class="space-y-6">
                        ...
                        <div class="pt-4">
                            <a href="{{ route('login') }}" class="block w-full py-3 px-4 bg-emerald-600 hover:bg-emerald-700 text-white font-medium rounded-lg text-center transition duration-300">
                                Start Investing Now
                            </a>
                        </div>
                    </div>
...
<section class="py-16 bg-gray-900 relative overflow-hidden">
    ...
    <div class="container mx-auto px-4 relative">
        ...
        <div class="mt-12 text-center">
            <a href="{{ route('register') }}" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-600 to-emerald-500 text-white font-medium rounded-lg transition duration-300 transform hover:scale-105">
...
<section class="py-16 bg-gray-900 relative overflow-hidden">
    ...
    <div class="container mx-auto px-4 relative">
        ...
        <div class="mt-12 text-center">
            ...
            <a href="{{ route('login') }}" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-600 to-emerald-500 text-white font-medium rounded-lg transition duration-300 transform hover:scale-105">
