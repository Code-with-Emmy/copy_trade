            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-2">
                        <i data-lucide="activity" class="w-8 h-8 inline mr-3 text-primary-600 dark:text-primary-400"></i>
                        My Trading Signals
                    </h1>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="p-2 bg-primary-100 dark:bg-primary-900/30 rounded-lg mr-3">
                                        <i data-lucide="trending-up" class="w-4 h-4 text-primary-600 dark:text-primary-400"></i>
                                    </div>
