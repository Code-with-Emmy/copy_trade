...
<div class="container mx-auto px-4 py-8">
    ...
    <!-- Plan Header -->
    <div class="bg-gradient-to-r from-primary-600 to-purple-600 text-white rounded-2xl p-8 mb-8 animate-fade-in shadow-lg">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between">
            <div>
                @if($plan->badge_text)
                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-white text-primary-800 mb-3">
                    {{ $plan->badge_text }}
                </span>
                @endif
                <h1 class="text-3xl md:text-4xl font-bold mb-2">{{ $plan->name }}</h1>
                @if($plan->description)
                <p class="text-primary-100 text-lg mb-4">{{ $plan->description }}</p>
                @endif
                ...
                <div class="p-6">
                    <form action="{{ route('user.plans.purchase') }}" method="POST" id="purchaseForm">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" id="amount" name="amount"
                                    ...
                                    class="pl-9 block w-full rounded-lg border border-gray-300 dark:border-gray-600 py-2.5 px-4 bg-white dark:bg-gray-900 text-gray-700 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-primary-500 dark:focus:ring-primary-600"
                                    required
                                >
                            </div>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                <label for="payment_method_balance" class="cursor-pointer">
                                    ...
                                    <div class="flex items-center justify-center py-3 px-4 border border-gray-300 dark:border-gray-600 rounded-lg peer-checked:border-primary-500 peer-checked:bg-primary-50 dark:peer-checked:bg-primary-900/30 peer-checked:text-primary-600 dark:peer-checked:text-primary-400">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg mb-6">
                            ...
                            <a href="{{ route('deposit') }}" class="text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 text-sm font-medium">
                                Add Funds
                            </a>
                        </div>

                        <!-- Submit Button -->
                        <button type="submit" id="invest-btn" class="w-full py-3 px-4 bg-primary-600 hover:bg-primary-700 text-white font-medium rounded-lg transition duration-300 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2">
                            Invest Now
                        </button>
                    </form>
                </div>
