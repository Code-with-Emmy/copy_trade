...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between animate-fade-in">
            ...
            <div class="mt-4 md:mt-0">
                <a href="{{ route('user.plans.my') }}" class="inline-flex items-center px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white rounded-lg transition-colors duration-300">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="stagger-item animate-fade-in plan-card rounded-xl overflow-hidden {{ $plan->featured ? 'featured' : '' }} bg-white dark:bg-gray-800">
            <!-- Plan Header -->
            <div class="relative">
                <div class="p-6 {{ $plan->featured ? 'bg-gradient-to-r from-primary-600 to-purple-600' : 'bg-gradient-to-r from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-800' }}">
                    @if($plan->badge_text)
                    <span class="absolute top-4 right-4 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $plan->featured ? 'bg-white text-primary-600' : 'bg-primary-100 text-primary-800 dark:bg-primary-900 dark:text-primary-200' }}">
                        {{ $plan->badge_text }}
                    </span>
                    @endif
                    ...
                    <div class="flex items-baseline mb-4">
                        ...
                        <span class="ml-2 {{ $plan->featured ? 'text-primary-100' : 'text-gray-500 dark:text-gray-400' }}">
                            min investment
                        </span>
                    </div>
            ...
            <div class="p-6">
                ...
                <a href="{{ route('user.plans.show', $plan->id) }}" class="block w-full text-center py-3 px-4 rounded-lg {{ $plan->featured ? 'bg-primary-600 hover:bg-primary-700 text-white' : 'bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-800 dark:text-white' }} font-medium transition-colors duration-300">
                    View Details
                </a>
            </div>
        </div>
