...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between">
            ...
            <div class="mt-4 md:mt-0">
                <a href="{{ route('user.plans.index') }}" class="inline-flex items-center px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white rounded-lg transition-colors duration-300">
    ...
    <div class="border-b border-gray-200 dark:border-gray-700 mb-6 overflow-x-auto">
        <div class="flex space-x-6">
            <a href="{{ route('user.plans.my', ['status' => 'all']) }}" class="py-3 px-1 border-b-2 {{ $status === 'all' ? 'border-primary-500 text-primary-600 dark:text-primary-400' : 'border-transparent text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300' }} whitespace-nowrap font-medium text-sm">
                All Plans
            </a>
            <a href="{{ route('user.plans.my', ['status' => 'active']) }}" class="py-3 px-1 border-b-2 {{ $status === 'active' ? 'border-primary-500 text-primary-600 dark:text-primary-400' : 'border-transparent text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300' }} whitespace-nowrap font-medium text-sm">
                Active
                @if($stats['active'] > 0)
                <span class="ml-1 px-2 py-0.5 bg-primary-100 text-primary-600 dark:bg-primary-900 dark:text-primary-400 rounded-full text-xs">{{ $stats['active'] }}</span>
                @endif
            </a>
            <a href="{{ route('user.plans.my', ['status' => 'pending']) }}" class="py-3 px-1 border-b-2 {{ $status === 'pending' ? 'border-primary-500 text-primary-600 dark:text-primary-400' : 'border-transparent text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300' }} whitespace-nowrap font-medium text-sm">
                Pending
                @if($stats['pending'] > 0)
            ...
            <a href="{{ route('user.plans.my', ['status' => 'completed']) }}" class="py-3 px-1 border-b-2 {{ $status === 'completed' ? 'border-primary-500 text-primary-600 dark:text-primary-400' : 'border-transparent text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300' }} whitespace-nowrap font-medium text-sm">
                Completed
            ...
            <a href="{{ route('user.plans.my', ['status' => 'cancelled']) }}" class="py-3 px-1 border-b-2 {{ $status === 'cancelled' ? 'border-primary-500 text-primary-600 dark:text-primary-400' : 'border-transparent text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300' }} whitespace-nowrap font-medium text-sm">
                Cancelled
            </a>
        </div>
    </div>
            ...
            <div class="p-6">
                ...
                <div class="flex flex-col sm:flex-row justify-between mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                    ...
                    <div class="mt-4 sm:mt-0 space-x-2">
                        ...
                        <a href="{{ route('user.plans.payment', $userPlan->id) }}" class="inline-flex items-center px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white text-sm rounded-lg transition-colors duration-300">
                        ...
                        @else
                        <a href="{{ route('user.plans.details', $userPlan->id) }}" class="inline-flex items-center px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white text-sm rounded-lg transition-colors duration-300">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
