            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('user.plans.index') }}" class="ml-1 text-sm font-medium text-gray-700 hover:text-primary-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">Investment Plans</a>
                    </div>
                </li>
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('user.plans.show', $plan->id) }}" class="ml-1 text-sm font-medium text-gray-700 hover:text-primary-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">{{ $plan->name }}</a>
                    </div>
                </li>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <form action="{{ route('user.plans.process', $plan->id) }}" method="POST" id="investmentForm">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="mt-2">
                                <div class="relative">
                                    ...
                                    <input type="number" id="amount" name="amount" value="{{ old('amount', $plan->min_amount) }}" min="{{ $plan->min_amount }}" max="{{ $plan->max_amount }}" step="0.01" required class="pl-10 block w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:bg-gray-800 dark:text-white sm:text-sm">
                                </div>
                                @error('amount')
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="relative">
                                    ...
                                    <label for="wallet" class="block cursor-pointer p-4 border border-gray-300 dark:border-gray-600 rounded-lg peer-checked:border-primary-500 peer-checked:ring-2 peer-checked:ring-primary-500 hover:border-gray-400 dark:hover:border-gray-500">
                                        <div class="flex items-center">
                                ...
                                <div class="relative">
                                    ...
                                    <label for="crypto" class="block cursor-pointer p-4 border border-gray-300 dark:border-gray-600 rounded-lg peer-checked:border-primary-500 peer-checked:ring-2 peer-checked:ring-primary-500 hover:border-gray-400 dark:hover:border-gray-500">
                                        <div class="flex items-center">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="mb-4">
                                <label class="inline-flex items-center">
                                    <input type="checkbox" name="compound_interest" value="1" class="rounded border-gray-300 text-primary-600 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-800">
                            ...
                            <div>
                                <label class="inline-flex items-center">
                                    <input type="checkbox" name="auto_renewal" value="1" class="rounded border-gray-300 text-primary-600 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-800">
                    ...
                    <div class="mb-8">
                        ...
                        <div>
                            ...
                            <input type="text" id="referral_code" name="referral_code" value="{{ old('referral_code') }}" class="block w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:bg-gray-800 dark:text-white sm:text-sm" placeholder="Enter referral code">
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                    ...
                    <div class="mb-8">
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input id="terms" name="terms" type="checkbox" required class="h-4 w-4 rounded border-gray-300 text-primary-600 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-800">
                            </div>
                            <div class="ml-3 text-sm">
                                <label for="terms" class="text-gray-700 dark:text-gray-300">I agree to the <a href="{{ route('terms') }}" class="text-primary-600 hover:text-primary-500 dark:text-primary-400">Terms of Service</a> and <a href="{{ route('privacy') }}" class="text-primary-600 hover:text-primary-500 dark:text-primary-400">Privacy Policy</a></label>
                            </div>
                        </div>
                        @error('terms')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
        ...
        <div>
            <div class="sticky top-6">
                ...
                <!-- Need Help Card -->
                <div class="bg-primary-50 dark:bg-primary-900/30 rounded-xl p-6 animate-fade-in stagger-item">
                    <h4 class="font-medium text-primary-900 dark:text-primary-300 mb-2">Need Help?</h4>
                    <p class="text-sm text-primary-700 dark:text-primary-400 mb-4">If you have any questions about this investment plan, our support team is available 24/7.</p>
                    <a href="{{ route('user.support') }}" class="inline-flex items-center text-sm font-medium text-primary-600 hover:text-primary-500 dark:text-primary-400 dark:hover:text-primary-300">
                        Contact Support
