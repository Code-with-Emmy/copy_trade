...
<style>
    ...
    .payment-method-option.selected {
        @apply border-primary-500 ring-2 ring-primary-500 bg-primary-50 dark:bg-primary-900/20;
    }
                    ...
                    <form action="{{ route('user.plans.payment.process', $userPlan->id) }}" method="POST" id="paymentForm">
                        ...
                        <div class="payment-sections">
                            ...
                            <div id="wallet-section" class="payment-section">
                                <div class="p-4 bg-primary-50 dark:bg-primary-900/20 rounded-lg mb-6">
                                    <div class="flex items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-primary-600 dark:text-primary-400 mr-2" viewBox="0 0 20 20" fill="currentColor">
                                ...
                                <a href="{{ route('user.deposits.new') }}" class="inline-flex items-center px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white rounded-md transition-colors duration-300">
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                                        <div class="relative">
                                            ...
                                            <label for="btc" class="block cursor-pointer p-4 border border-gray-300 dark:border-gray-600 rounded-lg peer-checked:border-primary-500 peer-checked:ring-2 peer-checked:ring-primary-500 hover:border-gray-400 dark:hover:border-gray-500">
                                                <div class="flex items-center">
                                        ...
                                        <div class="relative">
                                            ...
                                            <label for="eth" class="block cursor-pointer p-4 border border-gray-300 dark:border-gray-600 rounded-lg peer-checked:border-primary-500 peer-checked:ring-2 peer-checked:ring-primary-500 hover:border-gray-400 dark:hover:border-gray-500">
                                                <div class="flex items-center">
                                        ...
                                        <div class="relative">
                                            ...
                                            <label for="usdt" class="block cursor-pointer p-4 border border-gray-300 dark:border-gray-600 rounded-lg peer-checked:border-primary-500 peer-checked:ring-2 peer-checked:ring-primary-500 hover:border-gray-400 dark:hover:border-gray-500">
                                                <div class="flex items-center">
                                    ...
                                    <div class="p-6 bg-gray-50 dark:bg-gray-700 rounded-lg border border-gray-200 dark:border-gray-600">
                                        ...
                                        <p class="text-gray-600 dark:text-gray-300 mb-4">Please send exactly <span class="font-bold text-primary-600 dark:text-primary-400">0.0043 BTC</span> to the following address:</p>
                                        ...
                                        <div class="bg-white dark:bg-gray-800 p-3 rounded-md border border-gray-200 dark:border-gray-600 mb-4 flex items-center justify-between">
                                            ...
                                            <button type="button" class="text-primary-600 dark:text-primary-400 hover:text-primary-500 dark:hover:text-primary-300">
                                    ...
                                    <div class="mt-6">
                                        ...
                                        <input type="text" id="transaction_id" name="transaction_id" class="block w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:bg-gray-800 dark:text-white sm:text-sm" placeholder="Enter transaction ID after payment">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="bank-section" class="payment-section hidden">
                                <div class="mb-6">
                                    <div class="p-6 bg-gray-50 dark:bg-gray-700 rounded-lg border border-gray-200 dark:border-gray-600 mb-6">
                                        ...
                                        <p class="text-gray-600 dark:text-gray-300 mb-4">Please transfer <span class="font-bold text-primary-600 dark:text-primary-400">{{ Auth::user()->currency }}{{ number_format($userPlan->invested_amount, 2) }}</span> to the following bank account:</p>
                                        ...
                                        <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 dark:border-gray-600 border-dashed rounded-md">
                                            <div class="space-y-1 text-center">
                                                ...
                                                <div class="flex text-sm text-gray-600 dark:text-gray-400">
                                                    <label for="payment_proof" class="relative cursor-pointer bg-white dark:bg-gray-800 rounded-md font-medium text-primary-600 hover:text-primary-500 dark:text-primary-400 focus-within:outline-none">
                            ...
                            <div id="card-section" class="payment-section hidden">
                                <div class="mb-6">
                                    <div class="mb-6">
                                        ...
                                        <input type="text" id="card_number" name="card_number" class="block w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:bg-gray-800 dark:text-white sm:text-sm" placeholder="0000 0000 0000 0000">
                                    </div>

                                    <div class="grid grid-cols-2 gap-4 mb-6">
                                        <div>
                                            <label for="expiry_date" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Expiry Date</label>
                                            <input type="text" id="expiry_date" name="expiry_date" class="block w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:bg-gray-800 dark:text-white sm:text-sm" placeholder="MM/YY">
                                        </div>

                                        <div>
                                            <label for="cvv" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">CVV</label>
                                            <input type="text" id="cvv" name="cvv" class="block w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:bg-gray-800 dark:text-white sm:text-sm" placeholder="123">
                                        </div>
                                    </div>

                                    <div class="mb-6">
                                        <label for="card_holder" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Card Holder Name</label>
                                        <input type="text" id="card_holder" name="card_holder" class="block w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:bg-gray-800 dark:text-white sm:text-sm" placeholder="John Doe">
                                    </div>

                                    <div>
                                        <div class="flex items-center">
                                            <input id="save_card" name="save_card" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-primary-600 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-800">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 animate-fade-in stagger-item">
                        ...
                        <div class="mb-4">
                            <div class="flex items-center justify-between text-lg font-bold">
                                ...
                                <span class="text-primary-600 dark:text-primary-400">{{ Auth::user()->currency }}{{ number_format($userPlan->invested_amount + $userPlan->expected_profit, 2) }}</span>
                            </div>
                        </div>
                    </div>
