...
<div class="min-h-screen bg-gray-900 p-4 md:p-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-6 mb-8">
        <!-- USD Balance Card -->
        <div class="bg-gray-800 border border-gray-700 rounded-xl p-6 hover:border-primary-500/50 transition-all duration-300">
        ...
        <div class="bg-gray-800 border border-gray-700 rounded-xl p-6 hover:border-primary-500/50 transition-all duration-300">
            ...
            <div class="w-full h-1 bg-gray-700 rounded-full">
                <div class="w-2/3 h-full bg-gradient-to-r from-primary-400 to-primary-500 rounded-full"></div>
            </div>
        </div>
        @endif
        ...
        <div class="bg-gray-800 border border-gray-700 rounded-xl p-6 hover:border-primary-400/50 transition-all duration-300">
            <div class="flex items-center justify-between mb-4">
            ...
            <div class="w-full h-1 bg-gray-700 rounded-full">
                <div class="w-1/3 h-full bg-gradient-to-r from-primary-400 to-primary-500 rounded-full"></div>
            </div>
        </div>
        @endif
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        ...
        <div class="bg-gray-800 border border-gray-700 rounded-xl p-6">
            ...
            <form id="newSwapForm" class="space-y-6">
                ...
                <!-- Submit Button -->
                <button type="submit" id="swapSubmitBtn" class="w-full py-3 px-4 bg-gradient-to-r from-primary-600 to-primary-600 hover:from-primary-700 hover:to-primary-700 text-white font-medium rounded-lg transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed">
                    Swap Now
                </button>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        ...
        <div class="bg-gray-800 border border-gray-700 rounded-xl p-6">
            ...
            <div class="p-4 bg-primary-900/20 border border-primary-800 rounded-lg mb-6">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <p class="text-sm text-primary-300">Using fixed rates for guaranteed conversions. No slippage, no surprises.</p>
                    </div>
                </div>
            </div>
            ...
            <form id="accountSwapForm" class="space-y-6">
                ...
                <div class="grid grid-cols-2 bg-gray-900 rounded-lg overflow-hidden mb-2">
                    <button type="button" id="buyTab" class="py-3 px-4 text-center text-white bg-primary-600 font-medium">Buy Crypto</button>
                ...
                <div id="buyForm" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" id="buyAmount" class="pl-10 w-full bg-gray-900 border border-gray-700 text-white rounded-lg px-4 py-3 focus:ring-primary-500 focus:border-primary-500" placeholder="Enter amount" step="any">
                            <div class="absolute inset-y-0 right-0 flex items-center pr-3">
                                <button type="button" id="buyMaxBtn" class="text-xs bg-primary-600 hover:bg-primary-700 text-white py-1 px-2 rounded">MAX</button>
                            </div>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <select id="buyCrypto" class="w-full bg-gray-900 border border-gray-700 text-white rounded-lg pl-10 px-4 py-3 focus:ring-primary-500 focus:border-primary-500 appearance-none">
                ...
                <div id="sellForm" class="space-y-6 hidden">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <select id="sellCrypto" class="w-full bg-gray-900 border border-gray-700 text-white rounded-lg pl-10 px-4 py-3 focus:ring-primary-500 focus:border-primary-500 appearance-none">
                                <option value="btc">Bitcoin (BTC)</option>
                                <option value="eth">Ethereum (ETH)</option>
                                <option value="usdt">Tether (USDT)</option>
                                <option value="ltc">Litecoin (LTC)</option>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="number" id="sellAmount" class="w-full bg-gray-900 border border-gray-700 text-white rounded-lg px-4 py-3 focus:ring-primary-500 focus:border-primary-500" placeholder="Enter amount" step="any">
                            <div class="absolute inset-y-0 right-0 flex items-center pr-3">
                                <button type="button" id="sellMaxBtn" class="text-xs bg-primary-600 hover:bg-primary-700 text-white py-1 px-2 rounded">MAX</button>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        buyTabEl.addEventListener('click', function() {
            ...
            buyTabEl.classList.add('bg-primary-600', 'text-white');
        ...
        sellTabEl.addEventListener('click', function() {
            ...
            buyTabEl.classList.remove('bg-primary-600', 'text-white');
