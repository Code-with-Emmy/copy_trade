        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div class="flex items-center gap-4">
                <div class="w-12 h-12 bg-primary-500/10 rounded-xl flex items-center justify-center">
                    <i data-lucide="radio" class="w-6 h-6 text-primary-400"></i>
                </div>
                <div>
    ...
    @if (!$subscription)
        ...
        <div class="bg-gray-900 rounded-2xl border border-gray-700 overflow-hidden">
            <div class="p-8 text-center">
                <!-- Illustration -->
                <div class="mx-auto w-24 h-24 bg-gradient-to-br from-primary-500/20 to-purple-500/20 rounded-full flex items-center justify-center mb-6">
                    <i data-lucide="trending-up" class="w-12 h-12 text-primary-400"></i>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    <div class="bg-gray-800/50 rounded-xl p-4 border border-gray-700">
                        <div class="w-10 h-10 bg-primary-500/10 rounded-lg flex items-center justify-center mx-auto mb-3">
                            <i data-lucide="zap" class="w-5 h-5 text-primary-400"></i>
                        </div>
                ...
                <button
                    ...
                    class="bg-gradient-to-r from-primary-600 to-primary-700 hover:from-primary-700 hover:to-primary-800 text-white font-bold py-3 px-8 rounded-xl transition-all duration-200 hover:shadow-lg hover:shadow-primary-500/25 focus:outline-none focus:ring-2 focus:ring-primary-500/50"
                >
            ...
            <div class="lg:col-span-2 bg-gray-900 rounded-2xl p-6 border border-gray-700">
                <div class="flex items-start justify-between mb-6">
                    <div>
                        ...
                        <div class="flex items-center gap-2 text-2xl font-bold text-primary-400">
