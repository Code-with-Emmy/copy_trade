...
<div x-data="loanApplication()" class="min-h-screen bg-gray-50 dark:bg-gray-900 py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            ...
            <div class="text-center mb-8">
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-2">
                    <i data-lucide="credit-card" class="w-8 h-8 inline mr-3 text-primary-600 dark:text-primary-400"></i>
                    Loan Application
                </h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-sm ring-1 ring-gray-200 dark:ring-gray-800 text-center">
                <div class="p-3 bg-primary-100 dark:bg-primary-900/30 rounded-xl w-fit mx-auto mb-4">
            ...
            <form action="{{ route('loan') }}" method="post" class="p-6 space-y-6" @submit="handleSubmit">
                ...
                <div class="space-y-4">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white border-b border-gray-200 dark:border-gray-800 pb-2">
                        <i data-lucide="dollar-sign" class="w-5 h-5 inline mr-2 text-primary-600 dark:text-primary-400"></i>
                        Loan Details
                    </h3>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number"
                                       ...
                                       min="1000"
                                       step="100"
                                       class="w-full pl-12 pr-4 py-3 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-xl text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-primary-500 dark:focus:ring-primary-400 focus:border-transparent transition-all"
                        ...
                        <div>
                            ...
                            <select name="duration"
                                    ...
                                    required
                                    class="w-full px-4 py-3 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-xl text-gray-900 dark:text-white focus:ring-2 focus:ring-primary-500 dark:focus:ring-primary-400 focus:border-transparent transition-all">
                    ...
                    <div x-show="monthlyPayment > 0"
                        ...
                        <h4 class="text-sm font-semibold text-primary-900 dark:text-primary-300 mb-2">
                            <i data-lucide="calculator" class="w-4 h-4 inline mr-1"></i>
                            Estimated Monthly Payment
                        </h4>
                        <p class="text-2xl font-bold text-primary-600 dark:text-primary-400" x-text="`{{ $settings->currency }}${monthlyPayment.toFixed(2)}`"></p>
                        <p class="text-sm text-primary-700 dark:text-primary-300">Based on 8.5% APR (rates may vary)</p>
                    </div>
                </div>
                ...
                <div class="space-y-4">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white border-b border-gray-200 dark:border-gray-800 pb-2">
                        <i data-lucide="building-2" class="w-5 h-5 inline mr-2 text-primary-600 dark:text-primary-400"></i>
                ...
                <div class="space-y-4">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white border-b border-gray-200 dark:border-gray-800 pb-2">
                        <i data-lucide="user" class="w-5 h-5 inline mr-2 text-primary-600 dark:text-primary-400"></i>
                    ...
                    <div>
                        ...
                        <textarea name="purpose"
                                  required
                                  rows="4"
                                  class="w-full px-4 py-3 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-xl text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-primary-500 dark:focus:ring-primary-400 focus:border-transparent transition-all resize-none"
                ...
                <div class="bg-gray-50 dark:bg-gray-800 rounded-xl p-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">
                        <i data-lucide="file-check" class="w-5 h-5 inline mr-2 text-primary-600 dark:text-primary-400"></i>
                        Terms & Conditions
                    </h3>
                    ...
                    <div class="mt-4 flex items-center gap-3">
                        ...
                        <label for="terms" class="text-sm text-gray-900 dark:text-white">
                            I accept the <a href="#" class="text-primary-600 dark:text-primary-400 hover:underline">terms and conditions</a>
                            <span class="text-red-500">*</span>
                        </label>
                    </div>
                </div>
                ...
                <div class="pt-6">
                    <button type="submit"
                            ...
                            :class="acceptedTerms ? 'bg-gradient-to-r from-primary-600 to-primary-700 hover:from-primary-700 hover:to-primary-800 transform hover:scale-105' : 'bg-gray-400 cursor-not-allowed'"
                            class="w-full text-white font-semibold py-4 px-6 rounded-xl transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-800 flex items-center justify-center gap-2">
