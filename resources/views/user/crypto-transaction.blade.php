                ...
                <div class="flex-1">
                    ...
                    <div class="relative">
                        <input type="text"
                               ...
                               class="w-full bg-gray-900 border border-gray-600 text-white rounded-lg px-4 py-3 pl-10 focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all duration-200 placeholder-gray-500">
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    <div>
                        ...
                        <select x-model="selectedCurrency"
                                ...
                                class="bg-gray-900 border border-gray-600 text-white rounded-lg px-4 py-3 focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all duration-200">
        ...
        <div x-show="viewMode === 'cards'" class="hidden lg:block">
            <div class="grid grid-cols-1 xl:grid-cols-2 gap-4 p-6">
                ...
                <div class="bg-gray-700 border border-gray-600 rounded-xl p-6 hover:bg-gray-600/50 transition-all duration-200 hover:shadow-xl">
                    ...
                    <div class="pt-4 border-t border-gray-600">
                        <div class="flex items-center justify-between">
                            ...
                            <button class="inline-flex items-center px-3 py-1 bg-gray-800 hover:bg-gray-700 text-primary-400 hover:text-primary-300 text-sm font-medium rounded-md transition-colors duration-200">
                ...
                <div class="col-span-full text-center py-12">
                    ...
                    <a href="{{ route('assetbalance') }}"
                       class="inline-flex items-center px-6 py-3 bg-primary-600 hover:bg-primary-700 text-white font-medium rounded-xl transition-colors duration-200">
