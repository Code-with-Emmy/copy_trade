        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 max-w-2xl mx-auto p-6 md:p-8">
            <div class="flex items-center mb-6">
                <div class="p-3 bg-primary-100 dark:bg-primary-900/30 rounded-xl mr-4">
                    <i data-lucide="send" class="w-6 h-6 text-primary-600 dark:text-primary-400"></i>
                </div>
                <div>
            ...
            <form method="post" action="javascript:void(0)" id="transferform" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="email" id="email"
                            class="block w-full pl-10 pr-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"
                ...
                <div class="bg-primary-50 dark:bg-primary-900/20 p-4 rounded-xl">
                    <div class="flex items-start">
                        <div class="flex-shrink-0">
                            <i data-lucide="info" class="w-5 h-5 text-primary-600 dark:text-primary-400 mt-0.5"></i>
                        </div>
                        <div class="ml-3">
                            <h3 class="text-sm font-medium text-primary-800 dark:text-primary-300">Transfer Information</h3>
                ...
                <button type="submit" id="subbtn"
                    class="w-full inline-flex items-center justify-center gap-2 py-3 px-6 bg-primary-600 hover:bg-primary-700 text-white font-medium rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('transferform').addEventListener('submit', function(e) {
                ...
                (async () => {
                    ...
                    const { value: password } = await Swal.fire({
                        ...
                        customClass: {
                            popup: 'rounded-2xl',
                            confirmButton: 'bg-primary-600 hover:bg-primary-700 text-white rounded-xl px-6 py-2',
            ...
            document.getElementById('amount').addEventListener('input', function() {
                ...
                const feeInfo = document.querySelector('.text-primary-700.dark\\:text-primary-400');
                if (feeInfo) {
                    feeInfo.innerHTML = `
