...
<body>
    <header class="site-header">
        <div class="container nav-wrapper">
            <a href="{{ url('/') }}" class="nav-brand" aria-label="{{ $siteName }}">
                <img src="{{ $brandLogo }}" alt="{{ $siteName }} logo" class="nav-logo">
            </a>
            ...
            <div class="nav-cta">
                <a class="nav-link nav-login-link" href="{{ url('/login') }}">Log In</a>
                <a class="nav-btn btn-nav-primary" href="{{ url('/register') }}">Get Started</a>
            </div>
        ...
        <div class="mobile-menu" aria-hidden="true">
            ...
            <div class="mobile-nav-cta">
                <a class="nav-btn btn-nav-outline" href="{{ url('/login') }}">Log In</a>
                <a class="nav-btn btn-nav-primary" href="{{ url('/register') }}">Get Started</a>
            </div>
        </div>
    </header>
            ...
            <article class="error-card">
                <div class="error-grid">
                    <div class="error-code-panel">
                        ...
                        <img src="{{ asset('images/Copy-Trading.png') }}" alt="Trading dashboard preview" class="error-image" loading="lazy">
                    </div>
                    ...
                    <div class="error-copy">
                        ...
                        <p class="error-footnote">
                            ...
                            <strong>@yield('code')</strong> so our team can investigate quickly.
                        </p>
                    </div>
                </div>
                <div class="error-footer">
                    {{ $siteName }} · Secure Copy Trading Infrastructure
                </div>
            </article>
        </div>
    </main>
