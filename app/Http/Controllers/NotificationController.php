...
class NotificationController extends Controller
{
    ...
    public function adminIndex()
    {
        ...
        $unreadNotifications = $notificationItems->where('is_read', false);
        $readNotifications = $notificationItems->where('is_read', true);
        $title = 'Admin Notifications';

        return view('admin.notifications.index', compact('notifications', 'title', 'unreadNotifications', 'readNotifications'));
    }
