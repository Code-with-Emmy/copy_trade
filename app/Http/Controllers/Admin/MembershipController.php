...
class MembershipController extends Controller
{
    ...
    private function membershipPayload(?object $info): object
    {
        return (object) [
            'courses' => (object) [
                'data' => data_get($info, 'data.courses.data', data_get($info, 'data.courses', [])) ?: [],
            ],
            'categories' => data_get($info, 'data.categories', []) ?: [],
            'course' => data_get($info, 'data.course'),
            'lessons' => data_get($info, 'data.lessons.data', data_get($info, 'data.lessons', [])) ?: [],
        ];
    }
    ...
    public function showCourses(Request $request)
    {
        ...
        $payload = $this->membershipPayload($info);
    ...
    public function showLessons($id)
    {
        ...
        return view('admin.memebership.lessons', [
            ...
            'course' => $payload->course ?? (object) ['id' => $id, 'course_title' => 'Course'],
            'title' => 'Lessons'
        ]);
    }
