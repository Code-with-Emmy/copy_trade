...
class ManageAdminController extends Controller
{
   ...
   //block admin
    ...
    public function changestyle(Request $request)
    {
        ...
        $requestedStyle = $request->string('style')->toString();
        $currentStyle = (string) ($admin->dashboard_style ?: 'dark');

        if ($request->has('style')) {
            $dashboardStyle = $requestedStyle === 'true' ? 'dark' : 'light';
        } else {
            $dashboardStyle = $currentStyle === 'dark' ? 'light' : 'dark';
        }
        ...
        return redirect()->back()->with('success', 'Dashboard appearance updated.');
    }
