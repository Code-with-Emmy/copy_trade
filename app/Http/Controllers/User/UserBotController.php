...
class UserBotController extends Controller
{
    ...
    public function index()
    {
        ...
        $title = 'Bot Trading';
        return view('user.bot.index', compact('bots', 'userInvestments', 'title', 'settings'));
    }
    ...
    public function show(TradingBot $bot)
    {
        ...
        return view('user.bot.show', compact('bot', 'userInvestment', 'recentTrades', 'botStats', 'title', 'settings'));
    }
    ...
    public function dashboard()
    {
        ...
        return view('user.bot.dashboard', compact('investments', 'stats', 'recentTrades', 'title', 'settings'));
    }
    ...
    public function history(UserBotInvestment $investment)
    {
        ...
        return view('user.bot.history', compact('investment', 'trades', 'title', 'settings'));
    }
