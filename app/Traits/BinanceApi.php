            ...
            foreach ($orders as $order) {
                ...
                if ($data->status == "PAID") {
                    ...
                    try {
                        ...
                        \Log::error('Failed to send Binance deposit notification email to admin. Deposit ID: ' . $dp->id . ', User: ' . $user->email . '. Error: ' . $e->getMessage());
                    }
                    ...
                    try {
                        ...
                        \Log::error('Failed to send Binance deposit confirmation email to user. Deposit ID: ' . $dp->id . ', User: ' . $user->email . '. Error: ' . $e->getMessage());
                    }
                }
            }
        }
