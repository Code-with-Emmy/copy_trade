<div x-data="passwordLogic()" class="space-y-12">
    <form method="POST" action="<?php echo e(route('updateuserpass')); ?>" class="space-y-10">
        <?php echo csrf_field(); ?>
...
</script><?php /**PATH C:\Users\hp\Downloads\CopyTrader\resources\views/profile/update-password-form.blade.php ENDPATH**/ ?>