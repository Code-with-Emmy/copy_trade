    ...
    <div class="flex flex-col h-full">
      ...
      <div class="h-[78px] flex items-center justify-between px-6 border-b border-white/5 bg-black/30 backdrop-blur-md">
        <a href="<?php echo e(route('home')); ?>" class="flex items-center">
          <img src="<?php echo e(asset('storage/' . $settings->logo)); ?>" alt="logo" class="h-9 w-auto object-contain">
        </a>
...
<?php /**PATH C:\Users\hp\Downloads\CopyTrader\resources\views/layouts/dasht.blade.php ENDPATH**/ ?>