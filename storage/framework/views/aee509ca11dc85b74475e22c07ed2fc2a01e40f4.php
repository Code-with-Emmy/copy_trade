<?php if(session()->has('message')): ?>
    <div x-data="{ show: true }" x-show="show" x-transition.opacity class="w-full" data-inline-flash="message">
        <div class="dashboard-glass border border-rose-500/20 bg-rose-500/5 rounded-2xl px-5 py-4 relative overflow-hidden">
            ...
            <div class="flex items-start gap-3 pr-8">
                ...
                <div class="min-w-0">
                    <p class="text-[10px] font-black text-rose-400 uppercase tracking-[0.22em]">Action Required</p>
                    <p class="text-sm text-slate-200 mt-1 leading-relaxed"><?php echo e(session('message')); ?></p>
                </div>
            </div>
...
<?php endif; ?>
<?php /**PATH /Users/aierthinc/Desktop/CopyTrader/resources/views/components/danger-alert.blade.php ENDPATH**/ ?>