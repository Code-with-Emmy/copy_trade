    ...
    <div class="flex flex-col h-full">
      ...
      <div class="h-[78px] flex items-center justify-between px-6 border-b border-white/5 bg-black/30 backdrop-blur-md">
        <a href="<?php echo e(route('home')); ?>" class="flex items-center">
          <img src="<?php echo e(asset('storage/' . $settings->logo)); ?>" alt="BitCloven" class="h-9 w-auto object-contain">
        </a>
        ...
        <div
          ...
          <div class="flex items-center space-x-3 mb-5 relative">
            <div
              ...
              <img
                src="https://ui-avatars.com/api/?name=<?php echo e(urlencode(Auth::user()->name)); ?>&background=000&color=f0b90a&bold=true"
                alt="<?php echo e(Auth::user()->name); ?>" class="h-full w-full rounded-[14px] object-cover">
            </div>
            <div class="flex-1 min-w-0">
              <p class="text-xs font-black text-white truncate uppercase tracking-tight"><?php echo e(Auth::user()->name); ?></p>
      ...
      <nav class="flex-1 overflow-y-auto pb-16 pt-1 no-scrollbar">
        <div class="px-5">
          ...
          <div class="space-y-1">
            ...
            <a href="<?php echo e(route('myplans.default')); ?>"
              class="sidebar-link <?php echo e(request()->routeIs('myplans*') ? 'active' : ''); ?>">
              <i data-lucide="briefcase"></i>
              <span>My Portfolio</span>
            </a>

            <a href="<?php echo e(route('trade.index')); ?>"
              class="sidebar-link <?php echo e(request()->routeIs('trade.*') ? 'active' : ''); ?>">
              <i data-lucide="trending-up"></i>
              <span>Markets</span>
            </a>

            <a href="<?php echo e(route('copy.dashboard')); ?>"
              class="sidebar-link <?php echo e(request()->routeIs('copy.*') ? 'active' : ''); ?>">
              <i data-lucide="users-2"></i>
              <span>Copy Trading</span>
            </a>

            <a href="<?php echo e(route('user.bots.index')); ?>"
              class="sidebar-link <?php echo e(request()->routeIs('user.bots.*') ? 'active' : ''); ?>">
              <i data-lucide="bot"></i>
        ...
        <div class="px-5 mt-3">
          ...
          <div class="space-y-1">
            <a href="<?php echo e(route('deposits')); ?>" class="sidebar-link <?php echo e(request()->routeIs('deposits') ? 'active' : ''); ?>">
              <i data-lucide="plus-circle"></i>
              <span>Funding</span>
            </a>

            <a href="<?php echo e(route('withdrawalsdeposits')); ?>"
              class="sidebar-link <?php echo e(request()->routeIs('withdrawalsdeposits') ? 'active' : ''); ?>">
              <i data-lucide="arrow-up-right"></i>
              <span>Withdraw</span>
            </a>

            <a href="<?php echo e(route('accounthistory')); ?>"
              class="sidebar-link <?php echo e(request()->routeIs('accounthistory') ? 'active' : ''); ?>">
        ...
        <div class="px-5 mt-3">
          ...
          <div class="space-y-1">
            <a href="<?php echo e(route('profile')); ?>" class="sidebar-link <?php echo e(request()->routeIs('profile') ? 'active' : ''); ?>">
              <i data-lucide="settings-2"></i>
              <span>Account Settings</span>
            </a>

            <a href="<?php echo e(route('account.verify')); ?>"
              class="sidebar-link <?php echo e(request()->routeIs('account.verify') ? 'active' : ''); ?>">
              <i data-lucide="shield-check"></i>
              <span>Verification</span>
            </a>

            <a href="<?php echo e(route('referuser')); ?>"
              class="sidebar-link <?php echo e(request()->routeIs('referuser') ? 'active' : ''); ?>">
              <i data-lucide="user-plus"></i>
              <span>Referral</span>
            </a>

            <a href="<?php echo e(route('support')); ?>" class="sidebar-link <?php echo e(request()->routeIs('support') ? 'active' : ''); ?>">
  ...
  <div class="lg:ml-72 flex flex-col min-h-screen">
    ...
    <header class="top-nav px-8 lg:px-12 flex items-center justify-between sticky top-0 z-[50]">
      <div class="flex items-center lg:hidden">
        ...
        <img src="<?php echo e(asset('storage/' . $settings->logo)); ?>" alt="BitCloven" class="h-6 ml-4 opacity-80">
      </div>
        ...
        <div class="relative" x-data="{ open: false }">
          ...
          <div x-show="open" @click.away="open = false" x-transition:enter="transition ease-out duration-200"
            ...
            <div class="p-6 border-b border-white/5 bg-white/[0.02] flex items-center justify-between">
              ...
              <span
                class="text-[10px] font-black gold-text uppercase tracking-widest unread-count-badge"><?php echo e($unreadCount); ?>
            ...
            <div class="max-h-[400px] overflow-y-auto no-scrollbar">
              <?php $__empty_1 = true; $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div @click="markAsRead(<?php echo e($notification->id); ?>, $el)"
                  class="p-6 border-b border-white/5 hover:bg-white/[0.03] transition-colors cursor-pointer group <?php echo e(!$notification->is_read ? 'bg-yellow-500/[0.02]' : ''); ?>">
                  <div class="flex items-center space-x-4">
                    <div
                      ...
                      <i data-lucide="<?php echo e($notification->type === 'warning' ? 'alert-triangle' : ($notification->type === 'success' ? 'check-circle' : ($notification->type === 'danger' ? 'alert-octagon' : 'info'))); ?>"
                        class="w-4 h-4 <?php echo e($notification->type === 'warning' ? 'text-yellow-500' : ($notification->type === 'success' ? 'text-emerald-500' : ($notification->type === 'danger' ? 'text-rose-500' : 'text-blue-500'))); ?>"></i>
                    </div>
                    <div class="flex-1 min-w-0">
                      <p
        ...
        <div class="relative" x-data="{ profileOpen: false }">
          <button @click="profileOpen = !profileOpen"
            ...
            <span class="h-10 w-10 flex items-center justify-center rounded-xl overflow-hidden border border-white/10">
              <img
                src="https://ui-avatars.com/api/?name=<?php echo e(urlencode(Auth::user()->name)); ?>&background=111&color=f0b90a&bold=true&size=48"
                alt="<?php echo e(Auth::user()->name); ?>" class="h-full w-full object-cover">
            </span>
    ...
    <footer
      ...
      <p>&copy; <?php echo e(date('Y')); ?> <?php echo e($settings->site_name); ?>. Institutional Grade Asset Management.</p>
      <div class="flex items-center space-x-8">
        <a href="<?php echo e(route('terms')); ?>" class="hover:text-white transition-colors uppercase">Terms</a>
        <a href="<?php echo e(route('privacy')); ?>" class="hover:text-white transition-colors uppercase">Privacy</a>
  ...
  <div class="fixed bottom-0 left-0 right-0 z-[100] lg:hidden">
    <div class="mx-4 mb-6 dashboard-glass bg-black/60 border-white/10 p-2 overflow-visible">
      <div class="flex items-center justify-around relative">
        <a href="<?php echo e(route('dashboard')); ?>"
          class="flex flex-col items-center p-3 <?php echo e(request()->routeIs('dashboard') ? 'gold-text' : 'text-slate-500'); ?>">
          <i data-lucide="layout-grid" class="w-6 h-6"></i>
        </a>
        <a href="<?php echo e(route('trade.index')); ?>"
          class="flex flex-col items-center p-3 <?php echo e(request()->routeIs('trade.*') ? 'gold-text' : 'text-slate-500'); ?>">
        ...
        <a href="<?php echo e(route('myplans.default')); ?>"
          class="flex flex-col items-center p-3 <?php echo e(request()->routeIs('myplans*') ? 'gold-text' : 'text-slate-500'); ?>">
          <i data-lucide="briefcase" class="w-6 h-6"></i>
        </a>
        <a href="<?php echo e(route('profile')); ?>"
          class="flex flex-col items-center p-3 <?php echo e(request()->routeIs('profile') ? 'gold-text' : 'text-slate-500'); ?>">
...
<?php /**PATH /Users/aierthinc/Desktop/CopyTrader/resources/views/layouts/dasht.blade.php ENDPATH**/ ?>