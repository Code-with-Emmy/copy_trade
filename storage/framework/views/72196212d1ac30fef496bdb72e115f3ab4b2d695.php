...
<?php $__env->startSection('meta_description', 'Sign in to BitCloven to manage your copy trading subscriptions and monitor portfolio analytics.'); ?>
                ...
                <div class="space-y-4">
                    <?php $__currentLoopData = [
                        ...
                        <div class="flex items-center gap-3 text-slate-300">
                            ...
                            <span class="text-sm font-medium"><?php echo e($item); ?></span>
                        </div>
                ...
                <div class="glass-bright rounded-[32px] p-8 sm:p-12 relative overflow-hidden">
                    ...
                    <div class="relative z-10">
                        ...
                        <form action="<?php echo e(route('login')); ?>" method="POST" class="space-y-6">
                            ...
                            <div class="space-y-2">
                                <div class="flex justify-between items-center ml-1">
                                    ...
                                    <a href="<?php echo e(route('password.request')); ?>" class="text-[10px] font-bold uppercase tracking-widest text-[#f0b90a] hover:text-white transition-colors">Recover?</a>
                                </div>
                                <div class="relative">
                        ...
                        <div class="mt-8 pt-8 border-t border-white/5 flex flex-col items-center gap-4">
                            ...
                            <a href="<?php echo e(route('register')); ?>" class="text-[#f0b90a] font-bold text-sm hover:underline">Establish Account →</a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/aierthinc/Desktop/CopyTrader/resources/views/auth/login.blade.php ENDPATH**/ ?>