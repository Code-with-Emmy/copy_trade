    ...
    <div class="page-content-stack animate-in fade-in slide-in-from-bottom-6 duration-1000">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 md:gap-6">
            <div>
                <div class="flex items-center space-x-2 text-slate-500 text-xs font-bold uppercase tracking-widest mb-2">
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="hover:text-yellow-500 transition-colors">Admin</a>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-5 sm:gap-6">
            <div class="dashboard-glass p-6 sm:p-8 relative overflow-hidden group hover:border-yellow-500/20 transition-all">
                ...
                <div class="text-3xl font-black text-white tracking-tighter mb-2"><?php echo e(number_format($totalExperts)); ?></div>
                <div class="flex items-center text-[10px] font-bold text-slate-400 uppercase">
                    ...
                    <?php echo e(number_format($activeExperts)); ?> currently active
                </div>
            </div>
            ...
            <div class="dashboard-glass p-6 sm:p-8 relative overflow-hidden group hover:border-yellow-500/20 transition-all">
                ...
                <div class="text-3xl font-black gold-text tracking-tighter mb-2"><?php echo e(number_format($verifiedExperts)); ?></div>
                <div class="flex items-center text-[10px] font-bold text-slate-400 uppercase">
                    <i data-lucide="badge-check" class="w-3 h-3 mr-2 gold-text"></i>
                    <?php echo e(number_format($featuredExperts)); ?> featured on marketplace
                </div>
            </div>
            ...
            <div class="dashboard-glass p-6 sm:p-8 relative overflow-hidden group hover:border-yellow-500/20 transition-all">
                ...
                <div class="text-3xl font-black text-white tracking-tighter mb-2"><?php echo e(number_format($totalFollowers)); ?></div>
                <div class="flex items-center text-[10px] font-bold text-slate-400 uppercase">
            ...
            <div class="dashboard-glass p-6 sm:p-8 relative overflow-hidden group hover:border-yellow-500/20 transition-all">
                ...
                <div class="text-3xl font-black text-white tracking-tighter mb-2"><?php echo e(number_format($averageWinRate, 1)); ?>%</div>
                <div class="flex items-center text-[10px] font-bold text-slate-400 uppercase">
        ...
        <div class="grid grid-cols-1 xl:grid-cols-3 gap-8">
            <div class="xl:col-span-2 dashboard-glass overflow-hidden">
                <div class="p-8 border-b border-white/5 flex items-center justify-between bg-white/[0.02]">
                    ...
                    <span class="text-[10px] font-black text-slate-500 uppercase tracking-widest"><?php echo e(number_format($experts->count())); ?> loaded</span>
                </div>
                ...
                <?php if($experts->count() > 0): ?>
                                    ...
                                    <tr class="group hover:bg-white/[0.02] transition-colors">
                                        <td class="px-8 py-6">
                                            <div class="flex items-center space-x-4">
                                                <?php if($avatar): ?>
                                                    <img src="<?php echo e($avatar); ?>" class="w-12 h-12 rounded-2xl object-cover border border-white/10"
                                                ...
                                                <?php else: ?>
                                                    <div class="w-12 h-12 rounded-2xl bg-black border border-white/10 flex items-center justify-center text-white font-black">
                                                        <?php echo e(strtoupper(substr($expert->name, 0, 1))); ?>

                                                    </div>
                                                <?php endif; ?>
                                                <div>
                                                    <div class="flex items-center gap-2 flex-wrap">
                                                        <p class="text-sm font-bold text-white"><?php echo e($expert->name); ?></p>
                                                    ...
                                                    <p class="text-[10px] font-black uppercase tracking-widest text-slate-500 mt-1">
                                                        <?php echo e($expert->tag ?: ($expert->strategy_type ?: 'Expert Trader')); ?>

                                                    </p>
                                                    <div class="flex items-center gap-3 mt-2 flex-wrap">
                                                        <span class="text-[10px] font-black uppercase tracking-widest text-slate-400"><?php echo e(number_format((float) $expert->win_rate, 0)); ?>% win</span>
                                                        <span class="text-[10px] font-black uppercase tracking-widest text-slate-400"><?php echo e($riskLevel); ?> risk</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="px-8 py-6">
                                            <div class="space-y-2">
                                                <div class="text-sm font-black <?php echo e((float) $roiValue >= 0 ? 'text-emerald-400' : 'text-rose-400'); ?>">
                                                    <?php echo e((float) $roiValue >= 0 ? '+' : ''); ?><?php echo e(number_format((float) $roiValue, 2)); ?>%
                                                </div>
                                                <div class="text-[10px] font-black uppercase tracking-widest text-slate-500">
                                                    <?php echo e(number_format((float) ($expert->total_trades ?? 0))); ?> trades
                                                </div>
                                                <div class="text-[10px] font-black uppercase tracking-widest text-slate-400">
                                                    $<?php echo e(number_format((float) ($expert->aum ?? $expert->equity ?? 0), 2)); ?> AUM / equity
                                                </div>
                                            </div>
                                        </td>
                                        <td class="px-8 py-6">
                                            <div class="text-sm font-black text-white"><?php echo e(number_format((int) ($expert->followers ?? 0))); ?></div>
                                            <div class="text-[10px] font-black uppercase tracking-widest text-emerald-400 mt-1">
                                                <?php echo e(number_format((int) ($expert->active_copiers_count ?? 0))); ?> active
                                            </div>
                                        </td>
                                        <td class="px-8 py-6">
                                            <div class="text-sm font-black text-white">$<?php echo e(number_format((float) ($expert->price ?? $expert->minimum_allocation ?? 0), 2)); ?></div>
                                        ...
                                        <td class="px-8 py-6">
                                            <div class="flex items-center justify-end gap-2">
                                                ...
                                                <?php if(($expert->active_copiers_count ?? 0) == 0): ?>
                                                    <button type="button" onclick="deleteExpert(<?php echo e($expert->id); ?>)"
                    ...
                    <div class="px-8 py-5 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4">
                        <p class="text-[10px] font-black uppercase tracking-widest text-slate-500">
                            Showing <?php echo e($experts->firstItem() ?? 0); ?>-<?php echo e($experts->lastItem() ?? 0); ?> of <?php echo e($experts->total()); ?> experts
                        </p>
                        <div>
                ...
                <div class="dashboard-glass border-white/10 p-8">
                    ...
                    <div class="space-y-4">
                        <div class="rounded-2xl border border-white/5 bg-black/30 px-5 py-4">
                            ...
                            <p class="mt-2 text-2xl font-black text-white"><?php echo e(number_format($verifiedExperts)); ?></p>
                        ...
                        <div class="rounded-2xl border border-white/5 bg-black/30 px-5 py-4">
                            ...
                            <p class="mt-2 text-2xl font-black text-white"><?php echo e(number_format($featuredExperts)); ?></p>
                        ...
                        <div class="rounded-2xl border border-white/5 bg-black/30 px-5 py-4">
                            ...
                            <p class="mt-2 text-2xl font-black text-emerald-400"><?php echo e(number_format($activeExperts)); ?></p>
    ...
    <script>
        function deleteExpert(expertId) {
            Swal.fire({
                ...
                form.method = 'POST';
                form.action = `${<?php echo json_encode(url('/admin/copy'), 15, 512) ?>}/${expertId}`;

                const csrfToken = document.createElement('input');
                csrfToken.type = 'hidden';
                csrfToken.name = '_token';
                csrfToken.value = <?php echo json_encode(csrf_token(), 15, 512) ?>;
...
<?php echo $__env->make('layouts.admin-dasht', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/aierthinc/Desktop/CopyTrader/resources/views/admin/copy/index.blade.php ENDPATH**/ ?>