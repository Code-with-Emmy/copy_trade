...
<?php $__env->startSection('meta_description', 'The page you requested could not be found on ' . ($settings->site_name ?? config('app.name'))); ?>
                    ...
                    <div>
                        ...
                        <div class="mt-4">
                            ...
                            <div class="mt-6 flex flex-col sm:flex-row items-center gap-4">
                                <a href="<?php echo e(url('/')); ?>" class="h-14 inline-flex items-center justify-center px-6 rounded-2xl bg-[#f0b90a] text-black font-extrabold">Back to Home</a>
                                <a href="<?php echo e(route('register')); ?>" class="h-14 inline-flex items-center justify-center px-6 rounded-2xl border border-white/10 text-white">Create Account</a>
                            </div>

                            <p class="text-[12px] text-slate-500 mt-4">If this problem persists, contact <a href="mailto:<?php echo e($settings->support_email ?? 'support@' . (parse_url(config('app.url', ''), PHP_URL_HOST) ?? 'example.com')); ?>" class="text-[#f0b90a]">support</a> and include the URL and timestamp.</p>
                        </div>
                    </div>

                    <div class="text-center md:text-right">
                        <img src="<?php echo e(asset('images/Copy-Trading.png')); ?>" alt="Illustration" class="mx-auto md:ml-auto rounded-lg border border-white/6 max-w-[320px]">
                    </div>
...
<?php echo $__env->make('layouts.public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hp\Downloads\CopyTrader\resources\views/errors/404.blade.php ENDPATH**/ ?>